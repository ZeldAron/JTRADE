...
const Store = (() => {
  ...
  const DEFAULT_ACCOUNT_TYPES = [
    ...
    // LucidFlex — éval 1-phase soft, pas de daily loss, consistency 50% éval only
    { id: 'lucidflex-25k',   firmKey: 'lucid', subType: 'LucidFlex',   name: 'LucidFlex $25K',   capital:  25000, profitTarget: 1250, maxDrawdown: 1000, dailyLossLimit:    0, maxContracts:  2, feePerSide: 1.75 },
    { id: 'lucidflex-50k',   firmKey: 'lucid', subType: 'LucidFlex',   name: 'LucidFlex $50K',   capital:  50000, profitTarget: 3000, maxDrawdown: 2000, dailyLossLimit:    0, maxContracts:  4, feePerSide: 1.75 },
    { id: 'lucidflex-100k',  firmKey: 'lucid', subType: 'LucidFlex',   name: 'LucidFlex $100K',  capital: 100000, profitTarget: 6000, maxDrawdown: 3000, dailyLossLimit:    0, maxContracts:  6, feePerSide: 1.75 },
    { id: 'lucidflex-150k',  firmKey: 'lucid', subType: 'LucidFlex',   name: 'LucidFlex $150K',  capital: 150000, profitTarget: 9000, maxDrawdown: 4500, dailyLossLimit:    0, maxContracts: 10, feePerSide: 1.75 },
    // LucidPro — éval 2-phase strict, daily loss, consistency 40% funded, payout tous les 3j possible
    { id: 'lucidpro-25k',    firmKey: 'lucid', subType: 'LucidPro',    name: 'LucidPro $25K',    capital:  25000, profitTarget: 1250, maxDrawdown: 1000, dailyLossLimit:    0, maxContracts:  2, feePerSide: 1.75 },
    { id: 'lucidpro-50k',    firmKey: 'lucid', subType: 'LucidPro',    name: 'LucidPro $50K',    capital:  50000, profitTarget: 3000, maxDrawdown: 2000, dailyLossLimit: 1200, maxContracts:  4, feePerSide: 1.75 },
    { id: 'lucidpro-100k',   firmKey: 'lucid', subType: 'LucidPro',    name: 'LucidPro $100K',   capital: 100000, profitTarget: 6000, maxDrawdown: 3000, dailyLossLimit: 1800, maxContracts:  6, feePerSide: 1.75 },
    { id: 'lucidpro-150k',   firmKey: 'lucid', subType: 'LucidPro',    name: 'LucidPro $150K',   capital: 150000, profitTarget: 9000, maxDrawdown: 4500, dailyLossLimit: 2700, maxContracts: 10, feePerSide: 1.75 },
    // LucidDirect — instant funded, pas d'éval, consistency 20%, min 5 qualifying days par cycle
    { id: 'luciddirect-25k', firmKey: 'lucid', subType: 'LucidDirect', name: 'LucidDirect $25K', capital:  25000, profitTarget:    0, maxDrawdown: 1000, dailyLossLimit:    0, maxContracts:  2, feePerSide: 1.75 },
    { id: 'luciddirect-50k', firmKey: 'lucid', subType: 'LucidDirect', name: 'LucidDirect $50K', capital:  50000, profitTarget:    0, maxDrawdown: 2000, dailyLossLimit: 1200, maxContracts:  4, feePerSide: 1.75 },
    { id: 'luciddirect-100k',firmKey: 'lucid', subType: 'LucidDirect', name: 'LucidDirect $100K',capital: 100000, profitTarget:    0, maxDrawdown: 3500, dailyLossLimit: 2100, maxContracts:  6, feePerSide: 1.75 },
    { id: 'luciddirect-150k',firmKey: 'lucid', subType: 'LucidDirect', name: 'LucidDirect $150K',capital: 150000, profitTarget:    0, maxDrawdown: 5000, dailyLossLimit: 3000, maxContracts: 10, feePerSide: 1.75 },
  ...
  const DEFAULT_PROP_FIRMS = {
    ...
    lucid: { name: 'Lucid Trading', accounts: [
      // LucidFlex
      { id:'lucidflex-25k',   subType:'LucidFlex',   size:'25K',  capital:25000,  profitTarget:1250, maxDrawdown:1000, dailyLossLimit:0,    evalFee:100, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      { id:'lucidflex-50k',   subType:'LucidFlex',   size:'50K',  capital:50000,  profitTarget:3000, maxDrawdown:2000, dailyLossLimit:0,    evalFee:140, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      { id:'lucidflex-100k',  subType:'LucidFlex',   size:'100K', capital:100000, profitTarget:6000, maxDrawdown:3000, dailyLossLimit:0,    evalFee:225, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      { id:'lucidflex-150k',  subType:'LucidFlex',   size:'150K', capital:150000, profitTarget:9000, maxDrawdown:4500, dailyLossLimit:0,    evalFee:420, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      // LucidPro
      { id:'lucidpro-25k',    subType:'LucidPro',    size:'25K',  capital:25000,  profitTarget:1250, maxDrawdown:1000, dailyLossLimit:0,    evalFee:135, drawdownType:'Trailing EOD', consistency:'≤40% best day (funded)', minTradingDays:0, payoutConditions:'90/10 split — payout tous les 3 jours possible, one-day pass potential' },
      { id:'lucidpro-50k',    subType:'LucidPro',    size:'50K',  capital:50000,  profitTarget:3000, maxDrawdown:2000, dailyLossLimit:1200, evalFee:185, drawdownType:'Trailing EOD', consistency:'≤40% best day (funded)', minTradingDays:0, payoutConditions:'90/10 split — payout tous les 3 jours possible, one-day pass potential' },
      { id:'lucidpro-100k',   subType:'LucidPro',    size:'100K', capital:100000, profitTarget:6000, maxDrawdown:3000, dailyLossLimit:1800, evalFee:285, drawdownType:'Trailing EOD', consistency:'≤40% best day (funded)', minTradingDays:0, payoutConditions:'90/10 split — payout tous les 3 jours possible, one-day pass potential' },
      { id:'lucidpro-150k',   subType:'LucidPro',    size:'150K', capital:150000, profitTarget:9000, maxDrawdown:4500, dailyLossLimit:2700, evalFee:370, drawdownType:'Trailing EOD', consistency:'≤40% best day (funded)', minTradingDays:0, payoutConditions:'90/10 split — payout tous les 3 jours possible, one-day pass potential' },
      // LucidDirect (instant funded — pas d'éval, fee = prix d'achat du compte)
      { id:'luciddirect-25k', subType:'LucidDirect', size:'25K',  capital:25000,  profitTarget:0,    maxDrawdown:1000, dailyLossLimit:0,    evalFee:340, drawdownType:'Trailing EOD', consistency:'≤20% best day par cycle', minTradingDays:5, payoutConditions:'90/10 split — instant funded, min $500/cycle, pas de 8j wait' },
      { id:'luciddirect-50k', subType:'LucidDirect', size:'50K',  capital:50000,  profitTarget:0,    maxDrawdown:2000, dailyLossLimit:1200, evalFee:520, drawdownType:'Trailing EOD', consistency:'≤20% best day par cycle', minTradingDays:5, payoutConditions:'90/10 split — instant funded, min $500/cycle, pas de 8j wait' },
      { id:'luciddirect-100k',subType:'LucidDirect', size:'100K', capital:100000, profitTarget:0,    maxDrawdown:3500, dailyLossLimit:2100, evalFee:700, drawdownType:'Trailing EOD', consistency:'≤20% best day par cycle', minTradingDays:5, payoutConditions:'90/10 split — instant funded, min $500/cycle, pas de 8j wait' },
      { id:'luciddirect-150k',subType:'LucidDirect', size:'150K', capital:150000, profitTarget:0,    maxDrawdown:5000, dailyLossLimit:3000, evalFee:840, drawdownType:'Trailing EOD', consistency:'≤20% best day par cycle', minTradingDays:5, payoutConditions:'90/10 split — instant funded, min $500/cycle, pas de 8j wait' },
    ]},
