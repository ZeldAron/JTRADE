...
const Store = (() => {
  ...
  const DEFAULT_PROP_FIRMS = {
    ...
    lucid: { name: 'Lucid Trading', accounts: [
      ...
      { id:'lucidflex-50k',   subType:'Flex',   size:'50K',  capital:50000,  profitTarget:3000, maxDrawdown:2000, dailyLossLimit:0,    evalFee:140, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      ...
      { id:'lucidflex-150k',  subType:'Flex',   size:'150K', capital:150000, profitTarget:9000, maxDrawdown:4500, dailyLossLimit:0,    evalFee:420, drawdownType:'Trailing EOD', consistency:'≤50% best day (éval only, none funded)', minTradingDays:0, payoutConditions:'90/10 split — min 5 profitable days/cycle, min $500 payout, processing 2j' },
      // Lucid Pro
